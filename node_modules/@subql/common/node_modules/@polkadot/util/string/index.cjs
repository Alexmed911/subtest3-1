...
Object.defineProperty(exports, "stringPascalCase", {
  enumerable: true,
  get: function () {
    return _pascalCase.stringPascalCase;
  }
});
...
var _camelCase = require("./camelCase.cjs");

var _lowerFirst = require("./lowerFirst.cjs");

var _pascalCase = require("./pascalCase.cjs");

var _shorten = require("./shorten.cjs");

var _toHex = require("./toHex.cjs");

var _toU8a = require("./toU8a.cjs");

var _upperFirst = require("./upperFirst.cjs");